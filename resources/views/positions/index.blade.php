<x-app-layout>
    ...
    <div class="mb-6 flex gap-2 flex-wrap">
        <a href="{{ route('positions.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-900 text-white text-sm font-medium rounded-lg hover:bg-gray-800 transition-colors duration-200">
    ...
    <div class="table-container">
        <table id="positionsTable" class="w-full">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Nama Jabatan</th>
